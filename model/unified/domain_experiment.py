...
def run_job(output: Path, job: str, engines: tuple[str, ...], *, study: str = "domain") -> None:
    ...
    selection_dir = CONFIG_DIR if study == "domain" else DATA / "unified" / "seedbag_search"
    ...
    for name in engines:
        ...
        for seed in settings.seeds:
            key = (settings.weighting, settings.half_life_days, seed)
